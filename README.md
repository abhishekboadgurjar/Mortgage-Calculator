...
1. **Clone the repository**:
    ```bash
    git clone https://github.com/abhishekgurjarin/Mortgage-Calculator.git
    ```
...
You can check out the live demo of the Mortgage Calculator project [here](https://abhishekgurjarin.github.io/Mortgage-Calculator/).
## Screenshots
